    ...
    <div class="flex flex-1 flex-col justify-center py-12 ">
      <div class="mx-auto w-full max-w-md lg:w-120 p-10 card">
        ...
        <div class="flex gap-2 items-center justify-center">
          ...
          <h2 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100">Sign In</h2>
        </div>
        ...
        <div class="mt-8">
          ...
          <div class="relative mt-6">
            ...
            <div class="relative flex justify-center text-sm">
              <span class="bg-white dark:bg-neutral-800 rounded px-2 text-gray-500 dark:text-gray-200">Don't have An Account?</span>
            </div>
          </div>
          <div class="text-center mt-1">
            <nuxt-link to="/auth/register" class="font-medium text-indigo-600 hover:text-indigo-500 cp-btn-2 font-bold">Create New Account</nuxt-link>
          </div>
