...
<template>
  <div class="flex gap-2 min-h-[70vh]">
    <div class="flex flex-1 flex-col justify-center py-12 ">
      <div class="mx-auto w-full max-w-lg lg:w-120 p-5 lg:p-10 card">
        <span class="c"></span>
        <span class="c"></span>
        <span class="c"></span>
        <span class="c"></span>
        <div class="flex gap-2 items-center justify-center">
          ...
          <h2 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100">Register</h2>
        </div>

        <div class="mt-8">
          <div>
            <div>
              <p class="text-sm font-medium text-gray-500">Register with</p>

              <div class="mt-1 grid grid-cols-3 gap-3">
                <div>
                  <a href="#" class="inline-flex w-full justify-center rounded-md border border-gray-300 bg- white dark:bg-none py-2 px-4 text-sm font-medium text-gray-500 dark:text-gray-200 shadow-sm hover:text-orange-500">
                ...
                <div>
                  <a href="#" class="inline-flex w-full justify-center rounded-md border border-gray-300 bg- white dark:bg-none py-2 px-4 text-sm font-medium text-gray-500 dark:text-gray-200 shadow-sm hover:text-orange-500">
                    <span class="sr-only">Register with GitHub</span>
                    <svg class="h-5 w-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="relative mt-6">
              ...
              <div class="relative flex justify-center text-sm">
                <span class="bg-white dark:bg-neutral-800 rounded px-2 text-gray-500 dark:text-gray-200">Or continue with</span>
              </div>
            </div>
          </div>
          ...
          <div class="mt-6">
            <form class="space-y-6">
              ...
              <div>
                <button @click.prevent="loginUser" class="flex w-full justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Register</button>
              </div>
            </form>
          </div>
          ...
          <div class="relative mt-6">
            ...
            <div class="relative flex justify-center text-sm">
              <span class="bg-white dark:bg-neutral-800 rounded px-2 text-gray-500 dark:text-gray-200">Already have an account?</span>
            </div>
          </div>
          <div class="text-center mt-1">
            <nuxt-link to="/auth/login" class="font-medium text-indigo-600 hover:text-indigo-500 cp-btn-2 font-bold">LOG IN</nuxt-link>
          </div>
